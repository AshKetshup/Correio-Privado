...
//
//            userService.subscribeTopic(userRepo.findBySurname("meireles").getSurname(),topicRepo.findByTitle("Desporto").getTitle());
//            userService.subscribeTopic(userRepo.findBySurname("fernando").getSurname(),topicRepo.findByTitle("Festivais").getTitle());
//
//            userService.saveNews(new News("Benfica-Sporting","O jogo de benfica-sporting começará em breve",new Date(2022,5,22),userRepo.findBySurname("barbosa"),topicRepo.findByTitle("Desporto")));
//            userService.saveNews(new News("Festival de Coimbra","Coimbra terá um novo festival",new Date(2022,5,22),userRepo.findBySurname("lopesdasilva"),topicRepo.findByTitle("Festivais")));
//            userService.saveNews(new News("Tempestade","Tempestade forte na região norte",new Date(2022,5,22),userRepo.findBySurname("barbosa"),topicRepo.findByTitle("Metereologia")));
//            userService.saveNews(new News("Feira Municipal","Feira municipal a decorrer em Odemira",new Date(2022,5,22),userRepo.findBySurname("lopesdasilva"),topicRepo.findByTitle("Romarias e Feiras")));
//
//            userService.removeTopicSubscribed(userRepo.findBySurname("fernando").getSurname(),topicRepo.findByTitle("Festivais").getTitle());
//        };
//    }
}
